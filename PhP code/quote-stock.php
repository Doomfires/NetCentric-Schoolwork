...
<h1> <center> Quote Stock <center> </h1>
<div class="table"><center><h2 align="center"></h2>
...
<?php require("printquote.php");//might need to rearrange to that the company name and information is sensibly placed?>
</div>
